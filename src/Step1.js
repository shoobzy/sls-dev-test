      ...
      <div className="wrapper">
        ...
        >
          ...
          <div className="btn btn-quote-basis w-full">
            ...
            <label
              htmlFor="singleCover"
              className="flex w-full radius-5"
            >
              <svg className="z-20 pointer-events-none" width="12" height="35" viewBox="0 0 12 35" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="flex-grow">Just Me</span>
            </label>
          </div>
          ...
          <input
            ...
            <label
              ...
              className="flex w-full radius-5"
            >
              <svg className="z-20 pointer-events-none" width="24" height="35" viewBox="0 0 24 35" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="flex-grow">Me &amp; My Partner</span>
            </label>
          </div>
